...
int currentLED = 0;  // Variable para almacenar el LED que está encendido
int lastButtonState = HIGH; // Estado anterior del botón, para detectar cambios
...
void loop()
{
  ...
  // Detectar pulsación (transición de HIGH a LOW)
